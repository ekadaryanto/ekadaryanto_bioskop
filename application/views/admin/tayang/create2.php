    ...
    <div class="col-12">
        <div class="bg-secondary rounded h-100 p-4">
            <form action="<?=site_url('admin/tayang/doCreate')?>" method="POST" role="form">
                <h6 class="mb-4">Form Input Tayang</h6>
                ...
                <div class="form-floating mb-3">
                    <input type="text" name="tgl_waktu_tayang" class="form-control" id="datetimepicker1">
                    <label for="floatingInput">Waktu Tayang</label>
                </div>
                <div class="form-floating mb-3">
                    <input type="text" name="jml_kursi" class="form-control" id="">   
