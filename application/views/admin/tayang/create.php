...
<div id="content">
    ...
    <div class="container-fluid">
        <!-- DataTales Example -->
        <div class="col-12">
            <form action="<?=site_url('admin/tayang/doCreate')?>" method="POST" role="form">
                <legend>Form Input Tayang</legend>
                ...
                <div class="form-group">
                    ...
                    <select name="kd_bioskop" id="input" class="form-control" required="required">
                        <?php foreach ($bioskop as $b): ?>
                            <option value="<?=$b->kd_bioskop?>"><?=$b->nama_bioskop?></option>
                        <?php endforeach ?>
                    </select>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select name="judul_film" id="input" class="form-control" required="required">
                        <?php foreach ($film as $f): ?>
                            <option value="<?=$f->kd_film?>"><?=$f->judul_film?></option>
                        <?php endforeach ?>
                    </select>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input name="tgl_waktu_tayang" type="text" class="form-control" id="datetimepicker1">
                </div>

                <div class="form-group">
                    <label for="">Jumlah Kursi</label>
                    <input name="jml_kursi" type="text" class="form-control" id="" placeholder="">
                </div>
